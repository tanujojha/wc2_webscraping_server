...
let snapdeaURL = "https://www.snapdeal.com/products/electronics-headphones?sort=plrty";
...
let scrapeSnap = async ()=>{
    let res = await axios.get(snapdeaURL, {
        headers: {
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36"
        }
    });
...
export {scrapeAmz, scrapeFlip, scrapeSnap}
